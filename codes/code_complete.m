...
ds_path = [curr_path , '\input_images'];

a=imageSet(ds_path,'recursive');

total_folders= size(a,2);

for i=1 : total_folders
    I1=imread(a(1,i).ImageLocation{1,1});
    I2=imread(a(1,i).ImageLocation{1,2});
...
if size(matchedPoints1,1)> 15
    ...
    disp('Does not have Enough Matching Points')
end
